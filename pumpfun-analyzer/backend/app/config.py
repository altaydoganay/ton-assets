...
class Settings(BaseSettings):
    ...
    app_build: str = "98"
    app_build_label: str = "Paylaşım kartı gerçek maskot arka planları: artıda sevinen / ekside üzülen maskot otomatik; işlem kapanınca kart köşede otomatik belirir"
