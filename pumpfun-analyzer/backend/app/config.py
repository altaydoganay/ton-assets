...
class Settings(BaseSettings):
    ...
    app_build: str = "101"
    app_build_label: str = "AI Pump.fun avcısı: küçük scout girişi + 2.5x'te ana para çıkışı + 10x/25x kâr alımı + moonbag; faz-duyarlı stop/zaman çıkışı; kapanış hatası (qty_raw) düzeltildi"
