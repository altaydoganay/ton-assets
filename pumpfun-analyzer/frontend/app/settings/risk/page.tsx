...
const FIELDS: { key: string; label: string; type: "number" | "bool" | "text"; hint?: string }[] = [
  ...
  { key: "pure_mirror_mode", label: "Saf Kopya Modu (ölçüm)", type: "bool", hint: "AÇIK: otomatik çıkış (TP/SL/trailing/zaman) DEVRE DIŞI — yalnızca lider satınca satılır. Liderlerin GERÇEK kazancını net ölçmek için." },
  { key: "take_profit_pct", label: "Take-Profit (oran)", type: "number", hint: "0 = kapalı. 0.5 = +%50'de sabit kâr al (Saf Kopya KAPALIYKEN)" },
  { key: "stop_loss_pct", label: "Stop-Loss (oran)", type: "number", hint: "0 = kapalı. 0.25 = -%25'te zararı kes" },
  { key: "trailing_stop_pct", label: "Takip Eden Stop (oran)", type: "number", hint: "Fiyat zirveden bu kadar düşerse sat. 0.12 = %12. Kârı kilitler (0 = kapalı)" },
  { key: "trail_activate_pct", label: "Takip Stop Aktivasyon (oran)", type: "number", hint: "Takip eden stop, +%X kâra ulaşınca devreye girer. 0.15 = +%15" },
