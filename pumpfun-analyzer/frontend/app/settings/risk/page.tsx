...
const COPY_ENTRY: Field[] = [
  ...
  { key: "max_follow_lag_seconds", label: "Maksimum takip gecikmesi (CANLI)", type: "number", suffix: "sn", hint: "CANLI modda: lider aldıktan sonra sinyal bu süreyi aşarsa gerçek alım yapılmaz. Geç girişte tepeden alma riskini azaltır. Gerçek-zamanlı WS akışında gecikme ~0'dır." },
  { key: "max_follow_lag_seconds_paper", label: "Maksimum takip gecikmesi (PAPER)", type: "number", suffix: "sn", hint: "PAPER/test modunda geç-giriş toleransı. Helius/PumpPortal gerçek-zamanlı akışı yoksa copy olayları RPC yoklama ile dakikalar gecikmeyle gelir; bu değeri yüksek tutmak (örn. 300) paper'da copy işlemlerinin GÖRÜNMESİNİ sağlar. Canlıyı etkilemez." },
